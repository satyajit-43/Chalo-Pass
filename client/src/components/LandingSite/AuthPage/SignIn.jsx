    ...
    <div className="w-full rounded-lg md:mt-0 sm:max-w-md xl:p-0 bg-white border-[2px] border-black">
      <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
        ...
        <form className="space-y-4 md:space-y-6" onSubmit={login}>
          ...
          <button
            type="submit"
            className="w-full text-white focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-[#eb4757] hover:bg-blue-700 focus:ring-blue-800"
          >
            {loader ? (
              <>
                <Loader /> Verifying...
